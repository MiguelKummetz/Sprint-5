...
CREATE TABLE `platos` (
  ...
  CONSTRAINT `platos_ibfk_1` FOREIGN KEY (`categoriaId`) REFERENCES `categoria` (`id`)
...
INSERT INTO `platos` (`id`, `nombre`, `precio`, `disponible`, `categoriaId`) VALUES ('1', 'Pastel de Chocolate', '89', '1', '5'),
...
INSERT INTO `reservas` (`id`, `nombre`, `apellido`, `hora`, `fecha`, `cantidadmesa`) VALUES ('1', 'Juan', 'De la torre', '10:30:00', '2019-06-28', '3'),
