...
db.restaurants.find({name:/^Wil/i},{name: 1, borough: 1, cuisine:1})
...
db.restaurants.find({name:/ces$/i},{name: 1, borough: 1, cuisine:1})
...
db.restaurants.find({name:/Reg/i},{name: 1, borough: 1, cuisine:1})
...
db.restaurants.find({cuisine: "Seafood", $nor:[{cuisine:"American"},{cuisine:"Chinese"},{name:/^Wil/i}]},{name: 1, borough: 1, cuisine:1})
...
db.restaurants.find({"grades.date": ISODate("2014-08-11T00:00:00Z"), "grades.grade": "A", "grades.score": 11},{name: 1, grades: 1})
...
db.restaurants.find({"grades.1.date": ISODate("2014-08-11T00:00:00Z"), "grades.1.grade": "A", "grades.1.score": 9},{name: 1, grades: 1})
...
db.restaurants.find({"address.coord.1": {$gt: 42, $lt: 52}},{name: 1, adress: 1, borough: 1})
