...
SELECT producto.nombre, producto.precio, fabricante.nombre AS 'nombre de fabricante'
FROM producto
...
SELECT producto.codigo AS 'codigo de producto',
producto.nombre AS 'nombre de producto',
fabricante.codigo AS 'codigo de fabricante',
fabricante.nombre AS 'nombre de fabricante'
FROM producto
INNER JOIN fabricante ON producto.codigo_fabricante = fabricante.codigo;

-- 24 Retorna el nom del producte, el seu preu i el nom del seu fabricant, del producte més barat.
SELECT producto.nombre AS 'nombre de producto', producto.precio,
fabricante.nombre AS 'nombre de fabricante'
FROM producto
INNER JOIN fabricante ON producto.codigo_fabricante = fabricante.codigo
...
SELECT * FROM producto
INNER JOIN fabricante ON producto.codigo_fabricante = fabricante.codigo
WHERE fabricante.nombre = 'Asus' OR fabricante.nombre = 'Hewlett-Packard'
...
SELECT f.codigo, f.nombre, p.nombre AS 'nombre de producto' 
FROM fabricante f
